...
NOTE: Final run preset is `config/presets/production_k6_true_cte.yaml` (FINAL RUN CONFIG).
This preset uses True CTE as the core method and explicitly accepts Global TE OOM at k≥5, recording NaN and continuing.
